  ...
  ++  crub  !:
    ...
    ++  nu                                              ::
      ...
      ++  pit                                           ::  create keypair
        ...
        ..nu(pub [cry=(luck:ed c) sgn=(luck:ed s)], sek `[cry=c sgn=s])
      ::                                                ::  ++nol:nu:crub:crypto
      ++  nol                                           ::  activate secret
        |=  a=ring
        ...
        ..nu(pub [cry=pub:(luck:ed c) sgn=pub:(luck:ed s)], sek `[cry=c sgn=s])
      ::                                                ::  ++com:nu:crub:crypto
      ++  com                                           ::  activate public
        |=  a=pass
        =+  [mag=(end 3 a) bod=(rsh 3 a)]
        ~|  %not-crub-pubkey  ?>  =('b' mag)
        ..nu(pub [cry=pub:(rsh 8 bod) sgn=pub:(end 8 bod)], sek ~)
      --  ::nu
    --  ::crub
  ::                                                    ::
